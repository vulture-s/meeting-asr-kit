...
多人、多語、單點收音的會議。轉錄誰都會跑 —— 難的是那份稿子送到你面前時，
你不知道它漏了什麼、哪裡在猜。

而會議紀錄發出去之後就不只是一份文件了。之後每一次「當初講好的是什麼」、
「那個規格誰答應的」、「這個型號是哪一版」，都回頭引用它。
它變成那個專案的 ground truth ——
**錯在裡面的東西不會停在裡面，它會被後面每一次引用放大一次。**

所以這個 repo 的重點在**那份稿子有多少能信，而且說得出數字**。
...
*示範資料：講者與型號都是佔位的，音檔是程式產的，不是任何真實會議。*
